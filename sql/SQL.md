...
- 港口 (port) 1 --------- 起运港 ------ 订单 (shipping_order)
- 港口 (port) 1 --------- 目的港 ------ 订单 (shipping_order)
- 港口 (port) 1 --------- 起航 -------- 航段载重 (segment_capacity_usage)
- 港口 (port) 1 --------- 抵达 -------- 航段载重 (segment_capacity_usage)
...
- 航线 (shipping_line) 1 ---- 引用 ---- 航段载重 (segment_capacity_usage)
- 船只 (vessel) 1 --------- 执行 -------- 航次靠泊 (voyage_berthing)
- 船只 (vessel) 1 --------- 执行 -------- 航次货单 (voyage_cargo_note)
- 船只 (vessel) 1 --------- 引用 -------- 航段载重 (segment_capacity_usage)
- 航次靠泊 (voyage_berthing) 1 -- 关联 -- 航次货单 (voyage_cargo_note)  （通过 line_id, vessel_id, voyage_date, sequence_no 逻辑关联）
