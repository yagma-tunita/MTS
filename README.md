...
| 删除货主公司 | `POST /api/v1/admin/shipper/:id/delete` |
| 删除船运公司 | `POST /api/v1/admin/shipping/:id/delete` |
...
| POST | `/api/v1/admin/shipper/:id/delete` | admin | 删除货主公司 |
| POST | `/api/v1/admin/shipping/:id/delete` | admin | 删除船运公司 |
