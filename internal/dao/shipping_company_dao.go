...
func (d *shippingCompanyDAOImpl) UpdateMap(id int64, updates map[string]interface{}) error {
	return d.db.Model(&model.ShippingCompany{}).Where("company_id = ?", id).Updates(updates).Error
}
